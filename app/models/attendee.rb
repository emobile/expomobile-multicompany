class Attendee < ActiveRecord::Base
  ...
  validates :a_cellphone, :a_email, :a_market_segment, :a_name, :a_num_employees, :a_platform, :e_city, :e_colony, :e_ext_number, :e_lada, :e_municipality, :e_name, :e_phone, :e_rfc, :e_state, :e_street, :e_tradename, :e_zip_code, :event_id, :confirmation_token, :presence => true
